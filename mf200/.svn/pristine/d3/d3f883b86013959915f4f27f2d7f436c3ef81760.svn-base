<template>
	<div id="d3">
		...
		<p>调休原因 <input type="text" placeholder="请输入调休原因" id="reason"></p>
		<p>调休时间</p>
		<span>
			<nav>开始时间<input type="text" placeholder="请选择调休开始时间" id="ECalendar_case1"></nav>
			<nav>结束时间<input type="text" placeholder="请选择调休结束时间" id="ECalendar_case2"></nav>
		</span>
		<p>调休天数<input type="text" id="day" placeholder="请输入调休天数"></p>
		<p>加班时间</p>
		<span>
			<nav>开始时间<input type="text" placeholder="请选择加班开始时间" id="s"></nav>
			<nav>结束时间<input type="text" placeholder="请选择加班结束时间" id="e"></nav>
		</span>
...
export default {
		...
		methods: {
			...
			add(){
				var sendData = {};
				var jsonData = {};
				sendData.url = "/index.php/pc/Leave/off_add";
				...
				jsonData.time_1 = $('#s').val();
				jsonData.time_2 = $('#e').val();
