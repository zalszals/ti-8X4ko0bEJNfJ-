...
function getFaceInfo(sendData){
  ...
  token = localStorage.getItem("mf_token") ? localStorage.getItem("mf_token") : 'her39jr3lqstuma6loltm3q3u7'; 
  //token = localStorage.getItem("mf_token") ? localStorage.getItem("mf_token") : '7v64u0m1s541ifjh8726qu22f3'; 
  phone = localStorage.getItem("mf_account") ? localStorage.getItem("mf_account") : '18114158894';
