...
<div id="left-box" >
    <div style=" width: 100%; height: 100%;" >
        ...
        <div class="newdivtop"> 
        <h4 style="font-weight:bold;"><font style="display:inline-block; margin-top:20px;">供货管理&nbsp;&nbsp;<span class="h4spana">|&nbsp;&nbsp;确认收货</span></font>

            <span class="h4span-r" style="background-color:#b0c777;">返 回</span>
            <span class="h4span-r">确 认</span>
        ...
        <div  class="sell_center">
            ...
            <p style="margin-bottom:30px; font-size:16px;">
                <span style="display:inline-block; width:200px;">总量：2000 Kg</span>
                <span>总额：2000 元</span>
            </p>
            ...
            <p style="margin-bottom:30px; font-size:16px;">
                ...
                <span style="width:420px; display:inline-block;">
                    ...
                    <label style="width:150px;  font-weight:normal;">无</label>
                </span>
            </p>
                ...
                <p style="margin-bottom:20px; font-size:16px;">  
                   <span style="width:420px; display:inline-block;">
                        ...
                        <label style="width:150px; font-weight:normal;">2018-04-05</label>
                    </span>
                </p>
                ...
                <p style="margin-bottom:20px; font-size:16px;">
                   <span style="width:420px; display:inline-block;">
                        ...
                        <label style="width:150px; font-weight:normal;">4轴挂车</label>
                    </span>
                    <span style="width:420px; display:inline-block;">
                        <label style="width:70px; display:inline-block; font-size:15px; font-weight:normal;">车牌号：</label>
                        <label style="width:150px; font-weight:normal;">挂L044444</label>
                    </span>
                </p>
                ...
                <p style="margin-bottom:20px; font-size:16px;">
                   <span style="width:420px; display:inline-block;">
                        ...
                        <label style="width:150px; font-weight:normal;">常温</label>
                    </span>
                    <span style="width:420px; display:inline-block;">
                        <label style="width:120px; display:inline-block; font-size:15px; font-weight:normal;">司机姓名：</label>
                        <label style="width:150px; font-weight:normal;">李六</label>
                    </span>
                </p>
                ...
                <p style="margin-bottom:20px; font-size:16px;">
                   <span style="width:420px; display:inline-block;">
                        ...
                        <label style="width:150px; font-weight:normal;">13055556666</label>
                    </span>
                    <span style="width:420px; display:inline-block;">
                        <label style="width:120px; display:inline-block; font-size:15px; font-weight:normal;">预计送达时间：</label>
                        <label style="width:150px; font-weight:normal;">2018-05-01</label>
                    </span>
                </p>

                <h4 class="rightzhg">状态：在路上</h4>
